  ...
  return (
    <div className="animate-in fade-in duration-500">
      <div className="flex justify-between items-center mb-10">
        <div>
          <h1 className="text-3xl font-black text-foreground tracking-tight">환경 설정</h1>
      ...
      {/* Panel */}
      <div className="bg-card rounded-xl border border-border p-10 card-shadow min-h-[500px]">
          {activeTab === 'backup' && (
